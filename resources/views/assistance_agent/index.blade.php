    ...
    <div class="home-tab">
      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Vue d'ensemble des servants CAS</a>
          </li>
          {{--<li class="nav-item">
        ...
        <div>
          <div class="btn-wrapper">
            {{--@if (Auth::user()->can('create', App\Models\Sales\assistance_agent::class))--}}
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="assistance_agent" class="instances_lines table table-striped" data-url="assistance_agent" data-type="assistance_agent">
                      <thead>
                        <tr>
                          <th></th>
                          {{-- <th>
                      ...
                      <tbody>
                        ...
                        $start_index  = $assistance_agents->count() > 0 ? ($assistance_agents->currentPage()-1)*$assistance_agents->perPage() + 1 : 1;
                        ...
                        @foreach ($assistance_agents as $index => $assistance_agent)

                        @php
                             $assistance_agent_index = $start_index  + $index;
                        @endphp
                        <tr>
                          <td>
                            {{ $assistance_agent_index }}
                          </td>
                         {{-- -}} <td>
                            <div class="preview-thumbnail">
                            @php
                                if ($assistance_agent->logo) {
                                  $logo = asset("storage/assistance_agent_images/".$assistance_agent->logo->path);
                                } else {
                                  $logo = asset("storage/assistance_agent_images/default.png");
                                }
                               @endphp
                          ...
                          <td>
                            {{$assistance_agent->fullName()}}
                          </td>
 
                         {{--<td>
                            {{$assistance_agent->activity_area != null ? $assistance_agent->activity_area->name : ''}}
                          </td>--}}

                           {{--  <td>
                          $assistance_agent->activities 
                          </td>--}}

                       

                          <td>
                            {{$assistance_agent->email}}

                          </td>

                          <td>
                            {{$assistance_agent->main_phone_number}}
                          </td>
                          
                          <td>

                            @if ($assistance_agent->user)
                           
                            {{$assistance_agent->user->employee->full_name()}}
          ...
          <div class="row align-items-center py-5">
            ...
            <div class="col-12 text-center">
               <div class="custom-pagination">
                 ...
                 {{ $assistance_agents ->links('layouts.partials.pagination') }}
