...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
    <div class="toast-header">
      ...
      <strong id="import-text" class="me-auto">Importation en cours...</strong>
      <small class="d-none">11 mins ago</small>
  ...
  <div id="extracting-toast" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" tab-id="overview" role="tab"
                                aria-controls="overview" aria-selected="true">Menu d'importation</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#audiences" tab-id="audiences"
                                aria-controls="audiences" role="tab" aria-selected="false">Extractions reussies
                       ...
                       <li class="nav-item">
                        ...
                        aria-controls="demographics"  aria-selected="false">Extractions rejetées 
            ...
            aria-controls="digital" role="tab" aria-selected="false">Extractions dupliquées
              <span id="badge-warning" class="badge fw-bold text-white text-bg-warning">0</span></a>
                    ...
                    <div>
                        <div class="btn-wrapper">
                            <a href="{{ url('slip') }}" class="btn btn-primary text-white"><i
                                class="icon-book"></i>Liste des bordereaux</a>
                ...
                <div class="tab-content tab-content-basic">
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                        <div id="audience_tab" class="row flex-column align-items-center justify-content-center">
                          <div class="col-md-5 grid-margin stretch-card">
                            <div class="card" >
                                ...
                                {{--   <input readonly type="test" id="slip" name="slip" value="{{$slip->identification ?? Request::get('slip')}}" class="form-control fw-bold" placeholder="{{ __("Indiquez le numero de bordereau ici") }}" aria-label="{{ __("Indiquez le numero de bordereau ici") }}" aria-describedby="email-addon">
                                  ...
                                  <div class="form-group row m-2 align-items-center">
                                    ...
                                    <div id="slip-input" class="col-lg-7">
                                      <input readonly type="test" id="slip" name="slip" value="{{ Request::get('slip') ?? $slip_identification }}" class="form-control fw-bold" placeholder="{{ __("Indiquez le numero de bordereau ici") }}" aria-label="{{ __("Indiquez le numero de bordereau ici") }}" aria-describedby="email-addon">
                                  ...
                                  <div class="form-group row m-0 align-items-center">
                                    ...
                                    <div id="provider-input" class="col-lg-7">
                                      <input type="text" id="provider" name="provider" {{--  value="LABORATOIRE LOUIS PASTEUR" --}} value="{{Request::get('provider')}}" class="form-control fw-bold" placeholder="{{ __("Indiquez le prestataire ici") }}" aria-label="{{ __("Indiquez le prestataire ici") }}" aria-describedby="email-addon">
                              ...
                              {{-- --}}  <div class="form-group row m-0 align-items-center">
                                    <label for="time" class="col-lg-4 col-form-label mb-0 fw-bold">planifier l'extraction</label>
                                    {{-- <div id="date-input" class="col-lg-4">
                                    ...
                                    <div id="time-input" class="col-lg-4">
                                    
                                      <input type="time" id="time" name="time" value="" class="form-control fw-bold" placeholder="" aria-label="" aria-describedby="time-addon">
                                       
                                      <div class="valid-feedback fw-bold"  style="display: block">
                                      </div>
                                      <div  id="login-feedback" class="invalid-feedback feedback-timer fw-bold" style="display: block">
                                      </div>                   
                        ...
                        <div class="row col-md-5 grid-margin stretch-card">
                          ...
                          <div class="card" >
                            ...
                            <div class="card-body p-1 row justify-content-center">
                                    

                              <div class="form-group row m-0 align-items-center">
                                <label for="added_files" class="col-lg-6 col-form-label mb-0 fw-bold">Vous avez ajouté <span id="doc-count"> 0 </span> Dossier(s)</label>
              ...
              <input type="hidden" class=" form-control" id="instance_type" value="\App\Models\Extract">
                    ...
                    <div class="tab-pane fade" id="audiences" role="tabpanel" aria-labelledby="audiences">
                        ...
                        @include('layouts.partials._slip' , ['color'=>'success'])
                    ...
                    <div class="tab-pane fade" id="demographics" role="tabpanel" aria-labelledby="demographics">
                      ...
                      @include('layouts.partials._slip' , ['color'=>'danger'])
                    ...
                    <div class="tab-pane fade" id="digital" role="tabpanel" aria-labelledby="digital">
                        ...
                        @include('layouts.partials._slip' , ['color'=>'warning'])
...
function setFiles(input, files){
  ...
  input.files = dataTransfer.files
     ...
     // if (!check_limit()) {
        ...
        if(files.length > 500){
        alert("Vous pouvez ajouter au plus 500 factures")
        return null
        }
    ...
    //  }
      ...
      var previous_files = getFiles($(`.file-input`)[0]);

obj = $.merge( $.merge( [], previous_files ), e.dataTransfer.files );


setFiles($(`.file-input`)[0], obj);
...
//var   previous_files = previous_files;// getFiles($(`.file-input`)[0]);

//console.log(previous_files);


obj = $.merge( $.merge( [], previous_files ), files );


previous_files = obj;// getFiles($(`.file-input`)[0]);
...
setFiles($(`.file-input`)[0], obj);
  ...
  previous_files = files;// getFiles($(`.file-input`)[0]);
    ...
    //  console.log(files);
     ...
     //   uploadFolderRequest(form, url);
      ...
      removeFileFromFileList(form, container, index, parent , name)
      ...
      ${can_delete ? `<a  class="remove-file-from-list blink" data-name="${sanitize_filename(file.name)}" data-index="${index}" href="#"><i
      ...
      $("body").on('click', '.old-folder-fetcher', function(e) {
      e.preventDefault();
      ...
      for (const file of files) {
        ...
        if (file.type == "application/pdf") {
          ...
          count = start_index + files.length;
            ...
            loadingTask.promise.then(function(pdf) {
              ...
              pdf.getPage(pageNumber).then(function(page) {
                ...
                filePreviews.appendChild(wrapper);
                  ...
                  $("#doc-count").text(index + 1);

                if ((index + 1) == count) {// $(".items-preview").length) {
                  console.log('All Pages rendered');
                  $("#form-files .loader").addClass('d-none');
                  $("#save_files_button").removeClass("d-none");

                
                //  console.log($(".items-preview").length);
                ...
                setTimeout(() => wrapper.classList.add("animate"), index * 25);
      ...
      const removeFileFromFileList = (form, container, index, parent,name) => {
      ...
      for (let i = 0; i < files.length; i++) {
        const file = files[i];
        if (name !== sanitize_filename(file.name)) {
      ...
      parent.remove();
       ...
       $("#doc-count").text(parseInt($("#doc-count").text()) - 1);
...
$(`#${form} #file`).removeClass('is-invalid');
    ...
    let onSuccess = function(data, textStatus, xhr) {
        if (data.status) {
          ...
          uploadFiles(form, final_url, method , data.data.provider.name, data.data.slip.identification);
      ...
      ajaxRequest = constructAjaxRequest(`/api/slip`, data_send, onSuccess, onError, onComplete, method, processData, contentType, 'json');
...
sendAjaxRequest(ajaxRequest);
  ...
  Echo.private(`slip.${slip}`)
	  .listen('.slip.extracted', (data) => {
    ...
    url = data.redirect_to,
	  ...
	  //  console.log(folder.doc_name);
		  ...
		  $(`#upload-complete-duration-${folder.doc_name}`).text(`${is_new_folder ? folder.extraction_times[0].duration : '0' } s`);
		...
		if (is_new_folder) {
		  ...
		  $(`#global-progress-bar`).width(percent + '%')
			...
			alert(`Extraction(s) de ${extract_completed} facture(s) terminée`);
  
		  var badge_success = parseInt($(`#badge-success`).text()) ,
		  badge_warning = parseInt($(`#badge-warning`).text()) ,
		   badge_danger = parseInt($(`#badge-danger`).text()) ;
  
		   $("#home-tab").removeClass("active");
		   $("#overview").removeClass("show").removeClass("active");
  
		   $("#profile-tab").removeClass("active");
		   $("#audiences").removeClass("show").removeClass("active");
  
		   $("#digital-tab").removeClass("active");
		   $("#digital").removeClass("show").removeClass("active");
  
		   $("#contact-tab").removeClass("active");
		   $("#demographics").removeClass("show").removeClass("active");
  
			if (badge_success != 0) {
  
			   $("#profile-tab").addClass("active");
			$("#audiences").addClass("show").addClass("active");/**/
			  
			}
			else if(badge_warning != 0){
  
			  $("#digital-tab").addClass("active");
			  $("#digital").addClass("show").addClass("active");
  
			}
			else if(badge_danger != 0){
  
			  $("#contact-tab").addClass("active");
		   $("#demographics").addClass("show").addClass("active");
  ...
  function uploadFiles(form, final_url, method , provider , slip) {
...
for (var i = 0; i < files.length; i++) {
  ...
  data_send.append('provider', provider);
  data_send.append('slip', slip);
  ...
  if (allowedExtensions.includes(fileExtension)) {
   ...
   // console.log(data_send);
    ...
    let onSuccess = function(data, textStatus, xhr) {
        ...
        temp_file = data.data.file;
        temp_slip=data.data.slip;
        temp_index++;
...
$('#slip').val(temp_slip);
subscribe_event(temp_slip);


}
else{

subscribe_event($('#slip').val());
...
function newuploadFiles(form, final_url, method) {
...
//console.log(`temp_index == ${temp_index}`);
        ...
        if (temp_index == files.length + 1000 ) {
...
j++;
    ...
    //  console.log(sanitize_filename("SANGWA'A"));
...
/* 
     ...
     // ExtractFiles(form, final_url, method , timer);
     my_data_files.forEach(file => {
      
       NewExtractFiles(form, final_url, method , timer , file);
...
let form = $("#extract_files_button").closest("form").attr('id'),
  url_extract = $(`#${form} #url-extract`).val();
...
//if (true) {
  ...
  ExtractFiles(form, final_url, method , timer , files);
...
NewExtractFiles(form, final_url, method , timer , file);
      ...
      function ExtractFiles(form, final_url, method , timer,files) {
...
let onSuccess = function(data, textStatus, xhr) {
    if (data.status) {
      ...
      if (timer != "") {
        ...
        alert(`Planification du bordereau ${data.data.slip_identification} effectuée avec succès, vous pouvez fermer cette fenetre.`)
...
function NewExtractFiles(form, final_url, method , timer , file) {
...
let onSuccess = function(data, textStatus, xhr) {
    if (data.status) {
      ...
      if (timer != "") {
        ...
        alert(" effectuée avec succès, vous pouvez fermer cette fenetre.")
   ...
   //   var name=$("input[name='name']").val('');
    //  var email=$("input[name='email']").val('');
      ...
      //$(`#${table_id} tbody`).insertBefore
       $(`#${tab} .body-folder`).append(`
       <tr>
                          <td>${folder.identification}</td>
                          <td>${folder.doc_name}</td>
                          
                          <td>

                            <a class="update-item d-none fecth-invoice me-3 update blink"
                                href="#"><i
                                  class="menu-icon mdi mdi-plus-circle"></i>
                            </a>

                             <a  target=_blank  class="folder_${folder.code } me-3 print" href="${protocol}${host}/extract/${folder.code}" ><i class="menu-icon mdi mdi-eye"></i></a>
