                         ...
                         {{-- <td>
                          ...
                          <td>
                            <form>
                              ...
                              <a id="print_{{$ground_agent->code}}" class="me-3 print" href="{{url('ground_agent/'.$ground_agent->code)}}" ><i class="menu-icon mdi mdi-eye"></i></a>


                              <a id="edit_{{$ground_agent->code}}" class="me-3 edit" href="{{url('ground_agent/'.$ground_agent->code.'/edit')}}"><i class="menu-icon mdi mdi-table-edit"></i></a>
