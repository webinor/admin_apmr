    ...
    <div class="home-tab">
      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Vue d'ensemble des ressources humaines</a>
          </li>
          {{--<li class="nav-item">
                  ...
                  <div class="table-responsive">
                    <table class="instances_lines table table-striped" data-url="human_resource/employee/delete">
                      ...
                      <tbody>
                        ...
                        @if ( !in_array($employee->user->email,  ["kgabinmarcel@gmail.com" , "gabinhomarcelo@gmail.com"]   ))
