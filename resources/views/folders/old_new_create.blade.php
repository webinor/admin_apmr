...
<script>
      ...
      $($("#home-tab").attr("href")).removeClass("show");
      $($("#home-tab").attr("href")).removeClass("active");

      $("#profile-tab").addClass("active");
      $("#profile-tab").attr("aria-selected", "true");
      $($("#profile-tab").attr("href")).addClass("show");
      $($("#profile-tab").attr("href")).addClass("active");*/


      //console.log(data.slips[0].folders[0].provider);
      ...
      $.each(invoices, function(indexInArray, invoice) {
        ...
        if (already_exist.indexOf(invoice.service.name) == -1) {
          list += `<li>${invoice.service.name}</li>`;
        }
      ...
      console.log(tab);
      console.log(folder.insured.name);
      ...
      data-price="${price}"
      data-service="${invoice.service ? invoice.service.name : 'SELECTIONNEZ LE SERVICE CONCERNE'}">
                          ...
                          <td>${invoice.service ? invoice.service.name : 'SELECTIONNEZ LE SERVICE CONCERNE'}</td>
                          <td>
      ...
      /*
      console.log(JSON.parse($("#folder-test").val()));

      console.log($(".nav-link.active").attr("id"));

      //addCaseFile(JSON.parse($("#folder-test").val()) , $(".nav-link.active").attr("id") , null );
      */

      //addCaseFile(JSON.parse($("#folder-test").val()) , "digital" , null );
