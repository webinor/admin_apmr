...
<div class="row">
  <div class="col-sm-12">
    <div class="home-tab">
      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Vue d'ensemble des fournisseurs</a>
          </li>
          {{--<li class="nav-item">
    ...
    <a href="{{url('product/create')}}" class="btn btn-primary text-white me-0" ><i class="icon-download"></i>Nouveau produit</a>
                ...
                <div class="card-body">
                 ...
                 {{--  <h4 class="card-title">Liste des produits</h4>{{--  --}}
                  ...
                  <div class="table-responsive">
                    <table id="product" class="sortable instances_lines table table-striped" data-url="product" data-type="product">
                      <thead>
                        <tr>
                          <th>
                            Nom
                        ...
                        <tr>
                          ...
                          <td>
                            <form>
                              ...
                              <a    id="print_{{$product->code}}" class="product_{{$product->code }} me-3 print" href="{{url('product/'.$product->code)}}" ><i class="menu-icon mdi mdi-eye"></i></a>

                             

                             
                              <a    id="edit_{{$product->code}}" class="product_{{$product->code }} me-3 edit" href="{{url('product/'.$product->code.'/edit')}}"><i class="menu-icon mdi mdi-table-edit"></i></a>
                              

                              @can('delete', $product)
                            
                              <a id="delete_{{$product->code}}" class="product_{{$product->code }}  delete" href="#"><i class="menu-icon mdi mdi-close-circle"></i></a>
                              <input id="input_{{$product->code}}" type="hidden" value="{{$product->code}}">
                              <div id="loader" class="product_{{$product->code }}  d-none d-flex justify-content-center mt-3">
