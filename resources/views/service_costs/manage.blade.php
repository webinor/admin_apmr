...
<div class="row">
  <div class="col-sm-12">
    ...
    <a href="{{url('sales/service/create')}}" class="btn btn-primary text-white me-0" ><i class="icon-download"></i>Nouveau service / Prospect</a>
           ...
           @endif
            <a href="{{url('service_cost')}}" class="btn btn-primary text-white"><i class="icon-printer"></i>Liste des services</a>
          </div>
        </div>
      </div>
        ...
        <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">        
              ...
              <div class="card"> 
                <div class="card-body">
                  ...
                  <form id="form-service" class="pt-3 " novalidate method="post" action="{{url('product/create')}}">
                    ...
                    <input id="action" type="hidden"  value="{{$service ? 'edit' : 'create'}}" >
                    <input id="url" type="hidden"  value="{{"/api/service_cost".($service ? "/".$service->code."?_method=PUT" : "")}}" >
          ...
          <div class="form-group">
            ...
            <select  {{ $disabled }}  name="service_type" class="form-control" id="service_type" placeholder="">
              ...
              <option value="{{$service_type->code}}" {{ $service && $service->service_type->code == $service_type->code ? 'selected' : '' }}>{{$service_type->get_fullname()}}</option>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
              ...
              <input {{ $readonly }} type="text" value="{{ $service ? $service->get_service_name (): '' }}" name="service_name" class="autocomplete form-control" id="service_name" placeholder="Ex : Numeration formule sanguine" required>
          ...
          <div class="form-group">
            ...
            <select  {{ $disabled }}  name="coverage" class="form-control" id="coverage" placeholder="">
              ...
              <option value="0" {{ $service && $service->service_type->code == $service_type->code ? 'selected' : '' }}>Non Couverte</option>
              <option value="1" {{ $service && $service->service_type->code == $service_type->code ? 'selected' : '' }}>Couverte</option>
              <option value="2" {{ $service && $service->service_type->code == $service_type->code ? 'selected' : '' }}>Avis du medecin</option>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
              ...
              <input {{ $readonly }} type="number" value="{{ $service ? $service->get_quote (): '' }}" name="quote" class="autocomplete form-control" id="quote" placeholder="Ex : 30" required>
              @include('layouts.partials._feedback')
            </div>
          </div>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
              ...
              <input {{ $readonly }} type="text" value="{{ $service ? $service->keywords : '' }}" name="keywords" class="form-control" id="keywords" placeholder="Ex : formule, nfs , sanguine" required>
              @include('layouts.partials._feedback')
            </div>
          </div>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
              <label for="value_letter">valeur structure privée </label>
              <input {{ $readonly }} type="number" value="{{ $service ? $service->get_value_letter_private() : '' }}" name="value_letter" class=" value_letter form-control" data-provider-type ="prive" id="value_letter_private" placeholder="Ex: 160" required>
              <div class="valid-feedback">
              </div>
              <div class="invalid-feedback">
              </div>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
              <label for="value_letter">valeur structure confessionelle </label>
              <input {{ $readonly }} type="number" value="{{ $service ? $service->get_value_letter_confesional() : '' }}" name="value_letter" class=" value_letter form-control" data-provider-type ="confessionnel" id="value_letter_confesional" placeholder="Ex: 160" required>
              <div class="valid-feedback">
              </div>
              <div class="invalid-feedback">
              </div>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
              <label for="value_letter">valeur structure parapublique </label>
              <input {{ $readonly }} type="number" value="{{ $service ? $service->get_value_letter_parapublic() : '' }}" name="value_letter" class=" value_letter form-control" data-provider-type ="parapublique" id="value_letter_parapublic" placeholder="Ex: 160" required>
              <div class="valid-feedback">
              </div>
              <div class="invalid-feedback">
              </div>
          ...
          <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
              <label for="value_letter">valeur structure publique </label>
              <input {{ $readonly }} type="number" value="{{ $service ? $service->get_value_letter_public() : '' }}" name="value_letter" class=" value_letter form-control" data-provider-type ="publique" id="value_letter_public" placeholder="Ex: 160" required>
              <div class="valid-feedback">
              </div>
              <div class="invalid-feedback">
              </div>
          ...
          {{--  --}<div class="form-group">
            ...
            <select  {{ $disabled }}  name="coverage" class="form-control" id="coverage" placeholder="">
              ...
              <option value="0" {{ $service && $service->coverage == $coverage->code ? 'selected' : '' }}>{{__("Non Couvert")}}</option>
              <option value="1" {{ $service && $service->coverage == $coverage->code ? 'selected' : '' }}>{{__("Couvert")}}</option>
              <option value="2" {{ $service && $service->coverage == $coverage->code ? 'selected' : '' }}>{{__("Couvert Sous Confirmation")}}</option>
