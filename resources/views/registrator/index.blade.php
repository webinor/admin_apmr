...
<div class="row">
  <div class="col-sm-12">
    <div class="home-tab">
      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Vue d'ensemble des operateurs APMR</a>
          </li>
          {{--<li class="nav-item">
    ...
    <a href="{{url('registrator/create')}}" class="btn btn-primary text-white me-0" ><i class="icon-download"></i>Nouvel operateur APMR</a>
        ...
        <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
          ...
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Liste des operateurs APMR</h4>
                    ...
                    <table class="instances_lines table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         {{-- <td>
                            {{$registrator->image_url}}
                          </td>--}}
                          <td>
                            {{$registrator->fullName()}}
                          </td>
                          ...
                          <td>
                            {{ $registrator->city->name }}
                          </td>
                          <td>
                            {{$registrator->created_at}}
