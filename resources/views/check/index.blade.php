...
<div class="row">
  <div class="col-sm-12">
    <div class="home-tab">
      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
       ...
       {{--    @if ($slip -> unsaved_unvalidated_folders($folders) > 0)@endif 
 ...
 {{--   @if ($slip -> itemless_folders($folders) > 0) @endif
...
{{-- 
     @if ($slip -> saved_validated_folders($folders))  @endif 
     <li class="nav-item">
       <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#audiences" tab-id="audiences"
         ...
         --}}
          ...
          {{--  --}
          @if ($slip -> get_conforms_or_inconforms_folders($folders)["conforms"] > 0)@endif 
          ...
          <div class="row align-items-center py-5">
            ...
            <div class="col-12 text-center">
               <div class="custom-pagination">
                 ...
                 {{ $invoice_lines ->links('layouts.partials.pagination') }}
