...
<div class="row">
  <div class="col-sm-12">
    <div class="home-tab">
      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Vue d'ensemble des types de chaise</a>
          </li>
          {{--<li class="nav-item">
    ...
    <a href="{{url('wheel-chair/create')}}" class="btn btn-primary text-white me-0" ><i class="icon-download"></i>Nouveau type de chaise</a>
        ...
        <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
          ...
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Liste des types de chaise</h4>
                        ...
                        <tr>
                         ...
                         {{-- <td>
                          ...
                          <td>
                            ...
                            @if ($wheel_chair->admin && $wheel_chair->admin->employee)
                           
                            {{$wheel_chair->admin->employee->first_name}}   {{$wheel_chair->admin->employee->last_name}}
...
{{-- 
 ...
 --}}
                              @can('delete', $wheel_chair)

                              <a id="delete_{{$wheel_chair->code}}" class="delete" href="#"><i class="menu-icon mdi mdi-close-circle"></i></a>
                              <input id="input_{{$wheel_chair->code}}" type="hidden" value="{{$wheel_chair->code}}">
