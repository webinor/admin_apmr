...
<div id="old-file-previews-return-container" class="file-previews-return-container col-lg-2 overflow-auto" style="max-height: 800px;width: 12%;" >
...
<div  class="d-none d-flex justify-content-center mt-3">
    ...
    <div class="col-lg-10 grid-margin stretch-card" style="width: 88%;">
        <div class="card">
            <div class="card-body">
     ...
     <div class="d-flex">
      ...
      <div class=" row d-flex col-3">
        ...
        <div class="fw-bold mb-1 col-9 name" >{{ $folder ? $folder->provider->get_name() : '' }}</div>
      </div>
      ...
      <div class="row col-3">
        ...
        <div class="fw-bold col-7" >
          <ul class="reference_ids">
            ...
            <li  class="{{ $invoice->reference == "UNDEFINED REFERENCE" ? "text-danger" : "text-success" }}">{{ $invoice->reference }} 
              
              @include('layouts.partials._edit_template' , ['id'=> 'reference', 'url_update'=>('/api/update-reference')])
            ...
            @endif
                ...
                <h4 class="card-title text-center">Facture #
              ...
              <a href="#" data-folder="{{ $folder ? $folder->code : '' }}" data-table="{{ $folder ? $folder->code : '' }}" class="new-line btn btn-{{ $color }} fw-bold btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-plus"></i>Nouvelle ligne</a>
            ...
            @elseif ($folder && !$folder->validate_at)
