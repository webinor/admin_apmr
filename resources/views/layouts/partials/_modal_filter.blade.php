   ...
   <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
     <div class="modal-content">
       ...
       <div class="modal-body pt-0">
         <form id="form_filter" class="pt-0" novalidate method="GET" action="{{ url('slip/'. $slip->code ) }}">
           @csrf
           <input id="filter_url" type="hidden" value="{{ ('/api/count-filtered-results') }}">
           <input  id="slip" name="slip" class="form-control" type="hidden" value="{{ $slip->code }}">
           ...
           <div class="row">
            <div class="col-md-12">
              <div class="form-group fw-bold">
                ...
                <div class="form-check border-bottom">
                  <label class="form-check-label my-4" style="font-size: .9rem;">
                    <input id="folder-validated" name="folder-validated" {{ Request::get('folder-validated') ? 'checked' : '' }} type="checkbox" class="filter form-check-input form-control">
                    Exclure les PEC déja validées
                  <i class="input-helper"></i>
                <i class="green-icon mdi mdi-help-circle"></i>
              </label>
