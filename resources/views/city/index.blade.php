...
<div class="row">
  <div class="col-sm-12">
    <div class="home-tab">
      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Vue d'ensemble des villes</a>
          </li>
          {{--<li class="nav-item">
    ...
    <a href="{{url('city/create')}}" class="btn btn-primary text-white me-0" ><i class="icon-download"></i>Nouvelle ville</a>
                        ...
                        <tr>
                         ...
                         {{-- <td>
                          ...
                          <td>
                            ...
                            @if ($city->admin && $city->admin->employee)
                           
                            {{$city->admin->employee->first_name}}   {{$city->admin->employee->last_name}}
