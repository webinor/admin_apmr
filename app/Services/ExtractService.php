...
class ExtractService implements
    ...
    function getCreateVariables()
    {
       ...
       // $slip = new Slip();
       // $slip->code = Str::random(15);
        $slip_identification =$this->generate_identification(); //Str::upper(Str::random(8));
       // $slip->provider_id = 1;//$this->faker->regexify('/[0-9]{6}[A]{1}[0-9]{4}/'),
      //  $slip->user_id = session("user")->id;
      //  $slip->save();/**/
